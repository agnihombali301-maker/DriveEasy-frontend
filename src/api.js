...
export const admin = {
  ...
  createCar: (body) => api('/admin/cars', { method: 'POST', body: JSON.stringify(body) }),
  updateCar: (id, body) => api(`/admin/cars/${id}`, { method: 'PUT', body: JSON.stringify(body) }),
